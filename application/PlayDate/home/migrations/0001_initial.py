    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('verification', models.ImageField(blank=True, default=None, upload_to='verification')),
                ('address', models.ForeignKey(default=None, null=True, on_delete=django.db.models.deletion.SET_DEFAULT, to='home.address')),
            ],
            options={
                'db_table': 'Profile',
            },
